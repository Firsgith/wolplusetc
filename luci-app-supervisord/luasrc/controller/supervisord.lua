...
function index()
    ...
    entry({"admin", "system", "supervisord"}, cbi("supervisord"), _("Supervisord"), 95).dependent = true
    entry({"admin", "system", "supervisord", "status"}, call("status")).leaf = true
    entry({"admin", "system", "supervisord", "getver"}, call("getver")).leaf = true
    entry({"admin", "system", "supervisord", "update"}, call("update")).leaf = true
    entry({"admin", "system", "supervisord", "gettask"}, call("gettask")).leaf = true
    entry({"admin", "system", "supervisord", "starttask"}, call("starttask")).leaf = true
    entry({"admin", "system", "supervisord", "restarttask"}, call("restarttask")).leaf = true
    entry({"admin", "system", "supervisord", "stoptask"}, call("stoptask")).leaf = true
    entry({"admin", "system", "supervisord", "removetask"}, call("removetask")).leaf = true
    entry({"admin", "system", "supervisord", "addtask"}, call("addtask")).leaf = true
    entry({"admin", "system", "supervisord", "savetask"}, call("savetask")).leaf = true
    entry({"admin", "system", "supervisord", "getlog"}, call("getlog")).leaf = true
end
